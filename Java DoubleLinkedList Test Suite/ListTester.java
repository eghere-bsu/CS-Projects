...
public class ListTester {
	...
	//TO DO: THIS IS WHERE YOU CHOOSE WHICH LIST TO TEST
	...
	private void runTests() {
		...
		testTwoElementList(A_addToRearB_AB, "A_addToRearB_BA", LIST_AB, STRING_AB);
		...
		testThreeElementList(AB_iterAddCAfterNextA_ABC, "AB_iterAddCAfterNextA_ABC", LIST_ABC, STRING_ABC);
	...
	/** Scenario: [A,B] -> Iterator add(C) after next returns A -> [A,B,C] 
	 * @return [A,B,C]
	 */
	private IndexedUnsortedList<Integer> AB_iterAddCAfterNextA_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
	...
	private Scenario<Integer> AB_iterAddCAfterNextA_ABC = () -> AB_iterAddCAfterNextA_ABC();

	// TODO
	/** Scenario: [A,B,C] -> iteratorSetDAfterA -> [D,B,C] 
	 * @return [B,C]
	 */
	/*private IndexedUnsortedList<Integer> ABC_iterSetDAfterA_DBC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		Iterator<Integer> it = list.iterator();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iterSetDAfterA_DBC = () -> ABC_iterSetDAfterA_DBC();*/

	// The following section took four years off my lifespan in mental strain.
	/////////////////////////////////
	...
	private void testSingleElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter1PreviousRemove", testIterRemove(listIterAfterPrevious(scenario.build().listIterator(1), 1), Result.NoSuchElement));
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 1, contents[1], Result.MatchingValue));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter2PreviousIndex", testListIterPreviousIndex(scenario.build().listIterator(2), 0, Result.MatchingValue));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
			printTest(scenarioName + "_iterNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.True));
			printTest(scenarioName + "_iterNextRemove_testIterNext1", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), contents[1], Result.MatchingValue));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter2NextIndex", testListIterNextIndex(scenario.build().listIterator(2), 1, Result.MatchingValue));
				printTest(scenarioName + "_testListIter2HasPrevious", testListIterHasPrevious(scenario.build().listIterator(2), Result.True));
				printTest(scenarioName + "_testListIter2Previous", testListIterPrevious(scenario.build().listIterator(2), contents[1], Result.MatchingValue));
				printTest(scenarioName + "_testListIter2PreviousIndex", testListIterPreviousIndex(scenario.build().listIterator(2), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIter2Remove", testIterRemove(scenario.build().listIterator(2), Result.IllegalState));
				...
				printTest(scenarioName + "_testListIter3PreviousIndex", testListIterPreviousIndex(scenario.build().listIterator(3), 0, Result.MatchingValue));
